<nav x-data="{ open: false }" class="bg-white border-b border-gray-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 items-center">
            ...
            <a href="{{ route('dashboard') }}" class="text-sm font-semibold tracking-wide uppercase">
                Mini Blog
            </a>

            <div class="hidden sm:flex sm:items-center sm:space-x-6">
                <a href="{{ route('dashboard') }}" class="text-gray-600 hover:text-gray-800 text-sm tracking-wide uppercase">
                    Dashboard
                </a>
    ...
    <div :class="{'block': open, 'hidden': !open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4 text-gray-500 text-xs uppercase tracking-wide">
                Compte
            </div>
